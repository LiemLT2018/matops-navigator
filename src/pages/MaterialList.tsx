...
import { getMaterials, type Material } from '@/api/mockApi';
...
export default function MaterialListPage() {
  ...
  useEffect(() => {
    getMaterials().then(res => { setData(res.data); setLoading(false); });
  }, []);
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>{t('materials.list.specification')}</TableHead>
